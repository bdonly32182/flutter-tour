...
class ShoppingTour extends StatefulWidget {
  ShoppingTour({Key? key}) : super(key: key);

  @override
  _ShoppingTourState createState() => _ShoppingTourState();
}

class _ShoppingTourState extends State<ShoppingTour> {
  @override
  ...
  Container buildTabBooking(double height) {
    return Container(
