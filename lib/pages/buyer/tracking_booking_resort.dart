...
class TrackingBookingResort extends StatefulWidget {
  TrackingBookingResort({Key? key}) : super(key: key);

  @override
  _TrackingBookingResortState createState() => _TrackingBookingResortState();
}

class _TrackingBookingResortState extends State<TrackingBookingResort> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('ติดตามการจองบ้านพัก'),
      ),
      body: SafeArea(
        child: ListView(
          children: [
