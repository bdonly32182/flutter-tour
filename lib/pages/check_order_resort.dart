...
class CheckOrderResort extends StatefulWidget {
  final String orderId;
  CheckOrderResort({Key? key, required this.orderId}) : super(key: key);

  @override
  _CheckOrderResortState createState() => _CheckOrderResortState();
}

class _CheckOrderResortState extends State<CheckOrderResort> {
